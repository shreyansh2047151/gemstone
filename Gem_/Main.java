...
{
   abstract void register(); // abstract method
}
class gem 
{
 ...
 public static void add_gemstone()
	{
		...
		items=Integer.parseInt(st1.next());
    ...
    Scanner Exit_data=new Scanner(System.in);
     System.out.println("Do you Want to Exit -- yes/no");
                   ...
                   if(ans_response.equals(yes))
                    {
                        final String greetings="You are Exit....Thank You..";  //final keyword
...
Login reg_obj=new Login();
reg_obj.registerUser();
	...
	obj2.fover(4, "Black Spinel", 740, 30);
		...
		switch(ch)
		{
		  ...
		  case 2:
		      ...
		      System.out.println("Please Wait We are Fetching data");
		      ...
		      for(int i=0;i<=10;i++){
		       ...
		       try {
		         ...
		         Thread.sleep(500L);     //thread implemented 
		        }
		      ...
		      System.out.println("Sorry we dont have any Data");
		      break;
